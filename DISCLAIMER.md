...
Audio processing is designed to run locally. First-time use may still download
model weights or pronunciation resources from third-party package and model
hosts. Run `mcp-server-pronunciation doctor` before using the server in a live
session.
